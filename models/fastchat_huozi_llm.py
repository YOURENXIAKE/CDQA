...
class FastChatHuoZiLLM(RemoteRpcModel, LLM, ABC):
    api_base_url: str = "https://huozi.8wss.com/api/v1"
    ...
    def _call(self, prompt: str, stop: Optional[List[str]] = None) -> str:
        ...
        try:
            import openai
            # Not support yet
            openai.api_key = "tWR94sLZMQMkIULKGBk10JjUfbAesrsk"
    ...
    # 将历史对话数组转换为文本格式
    def build_message_list(self, query,system=None) -> Collection[Dict[str, str]]:
        ...
        sys = _build_message_template()
        sys['role'] = 'system'
        sys['content'] = system
        build_message_list.append(sys)
        build_message_list.append(user_build_message)
    ...
    def generatorAnswer(self, prompt: str,system="",
        ...
        client = OpenAI(api_key="tWR94sLZMQMkIULKGBk10JjUfbAesrsk", base_url="https://huozi.8wss.com/api/v1")
        # create a chat completion
        completion = client.chat.completions.create(
        model='Qwen/Qwen2-7B-Instruct',
        messages=self.build_message_list(prompt,system)
        )
