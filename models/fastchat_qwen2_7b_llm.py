...
class FastChatQwen27bLLM(RemoteRpcModel, LLM, ABC):
    ...
    def _call(self, prompt: str, stop: Optional[List[str]] = None) -> str:
        ...
        try:
            import openai
            # Not support yet
            openai.api_key = "sk-bclmwvpwfeloazhjrqxjbvywouxwatiiuxuigadwlbnyxjsz"
    ...
    def generatorAnswer(self, prompt: str,system="",
        ...
        client = OpenAI(api_key="sk-bclmwvpwfeloazhjrqxjbvywouxwatiiuxuigadwlbnyxjsz", base_url="https://api.siliconflow.cn/v1")
        # create a chat completion
